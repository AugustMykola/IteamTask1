...
import  * as userAssessmentsGraphsActions from './userAssessmentsGraphs.actions';
...
export function userAssessmentsGraphsReducer (state: userAssessmentsGraphsState | undefined, action: Action): userAssessmentsGraphsState {
